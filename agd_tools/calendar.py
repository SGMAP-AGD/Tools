...
vac_toussaint = MultiPeriod('vac_toussaint',
                            [('2012-10-27','2012-11-07'), ('2013-10-19','2013-11-04'),('2014-10-18','2014-11-03')],
                             zone = "zonz C")
vac_noel = MultiPeriod('vac_noel',
                       [('2012-12-22','2013-01-06'),('2013-12-21','2014-01-06'),('2014-12-20','2015-01-05')],
                       zone = "zonz C")
vac_hiver = MultiPeriod('vac_hiver',
                        [('2013-03-02','2013-03-17'),('2014-02-15','2014-03-03'),('2015-02-21','2015-03-09')],
                        zone = "zonz C")
vac_printemps = MultiPeriod('vac_printemps',
                            [('2013-04-27','2013-05-12'),('2014-04-12','2014-04-28'),('2015-04-25','2015-05-11')],
                            zone = "zonz C")
vac_ete = MultiPeriod('vac_ete',
                      [('2013-07-04','2014-09-03'),('2014-07-05','2015-09-02'),('2015-07-03','2015-09-01')],
                       zone = "zonz C")
